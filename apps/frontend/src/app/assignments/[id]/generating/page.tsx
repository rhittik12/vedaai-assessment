...
export default function GeneratingPage() {
  ...
  return (
    <div className="flex min-h-[calc(100vh-64px)] items-center justify-center px-4 py-10 sm:px-6">
      <div className="surface w-full max-w-2xl p-6 text-center sm:p-9">
        <div className="mx-auto flex h-16 w-16 items-center justify-center rounded-2xl bg-[#172033] text-white shadow-sm">
          <Sparkles className="h-8 w-8" />
        </div>

        <div className="mt-6 text-sm font-bold uppercase tracking-[.16em] text-[#e96025]">VedaAI is working</div>
        <h1 className="mt-3 text-3xl font-bold tracking-[-.035em] text-[#172033]">Generating your question paper</h1>
        <p className="mt-3 text-sm leading-6 text-[#667085]">We&apos;re structuring the paper around the requirements you provided.</p>
            ...
            return (
              <div
                ...
                className={`flex items-start gap-3 rounded-2xl border p-4 transition ${
                  isDone ? 'border-emerald-200 bg-emerald-50' : isActive ? 'border-[#f1c1aa] bg-[#fff8f5]' : 'border-[#edf0f4] bg-[#fbfcfd]'
                }`}
              >
                ...
                <div className="flex-1">
                  ...
                  {isActive ? <div className="mt-1 text-xs text-[#d85b24]">The model is structuring your paper.</div> : null}
                </div>
              </div>
            );
          })}
